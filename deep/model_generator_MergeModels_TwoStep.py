...
class Model_Generator():
    ...
    def fit(self, train_xTC, trainxEC, train_y, input_dim, test_x_TC =None, test_x_EC =None, test_y = None): #input_dim example: (600,)
        ...
        model_EC = Sequential()
        model_EC.add(Conv2D(filters=256, kernel_size=(1, 1), strides=(1, 1), padding="same", activation="relu", input_shape=input_shape))
        ...
        self.__network_EC.add(Conv2D(weights=model_EC.layers[0].get_weights(), filters=256, kernel_size=(1, 1), strides=(1, 1), padding="same", activation="relu", input_shape=input_shape))
        self.__network_EC.add(Conv2D(weights=model_EC.layers[1].get_weights(), filters=128, kernel_size=(15, 1), strides=(1, 1), padding="same", activation="relu", input_shape=input_shape))
        self.__network_EC.add(Conv2D(weights=model_EC.layers[2].get_weights(), filters=64, kernel_size=(12, 1), strides=(1, 1), padding="same", activation="relu", input_shape=input_shape))
        self.__network_EC.add(Conv2D(weights=model_EC.layers[3].get_weights(), filters=32, kernel_size=(9, 1), strides=(1, 1), padding="same", activation="relu", input_shape=input_shape))
        self.__network_EC.add(Conv2D(weights=model_EC.layers[4].get_weights(), filters=16, kernel_size=(5, 1), strides=(1, 1), padding="same", activation="relu", input_shape=input_shape))
        self.__network_EC.add(Conv2D(weights=model_EC.layers[5].get_weights(), filters=8, kernel_size=(2, 1), strides=(1, 1), padding="same", activation="relu", input_shape=input_shape))
