...
mv5_l1_neuron_count_candidate = [1000]
mv5_l2_neuron_count_candidate = [1000]
mv5_l3_neuron_count_candidate = [500]
mv5_l4_neuron_count_candidate = [400] #[500]


# mv5_l1_neuron_count_candidate = [10000, 500, 1000]
# mv5_l2_neuron_count_candidate = [1000, 1000, 100]
# mv5_l3_neuron_count_candidate = [1000, 500, 1000]
# mv5_l4_neuron_count_candidate = [1000, 500, 1000]
mv5_l1_neuron_count = 0
mv5_l2_neuron_count = 0
mv5_l3_neuron_count = 0
mv5_l4_neuron_count = 0
...
def model_type_retrieval_v5(train_X, train_Y, test_X, test_Y):  # one_layer, count of neuron is count of types!
    print("layer1- neurons: ", mv5_l1_neuron_count, "\t", "layer2- neurons: ", mv5_l2_neuron_count, "\t",
          "layer3- neurons: ", mv5_l3_neuron_count, "layer4- neurons: ", mv5_l4_neuron_count, "\t epoch count: ", epoch_count)
    ...
    extra_name_v5_path += "_L4N(" + str(mv5_l4_neuron_count) + ")"
    ...
    model_type_retrieva_v1.add(Dense(mv5_l4_neuron_count))
    model_type_retrieva_v1.add(Activation('relu'))
