...
validations_report_path = os.path.join(base_path, "data" , "reports", "validation_reports_EC_Matrix2D_tfidf.csv")
test_report_path = os.path.join(base_path, "data" , "reports" , "test_reports_EC_Matrix2D_tfidf.csv")
