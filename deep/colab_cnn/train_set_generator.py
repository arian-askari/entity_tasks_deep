...
trainset_translation_matrix_detail_normal_path = os.path.join(base_path, 'trainset_translation_matrix_score_e_detail_t_normal_')
...
trainset_translation_matrix_cosine_typeDetail_path = os.path.join(base_path, 'trainset_translation_matrix_cosine_typeDetail_raw_')
trainset_translation_matrix_cosine_typeDetail_normal_path = os.path.join(base_path, 'trainset_translation_matrix_cosine_typeDetail_normal_')
...
def get_train_test_data_translation_matrix_3d_pat(top_entities=20, top_k_term_per_entity=50, use_tfidf = False):
    ...
    if use_tfidf == False:
        ...
        path = trainset_translation_matrix_3d_path + "tope(" + str(top_entities) + "topterm(" + str(top_k_term_per_entity) + "_tfidf.json"
    return path
