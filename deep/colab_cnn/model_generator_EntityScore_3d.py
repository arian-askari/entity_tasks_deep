...
class Model_Generator():
    ...
    def fit(self, train_x, train_y, input_dim, test_x =None, test_y = None): #input_dim example: (600,)
        ...
        self.__network.add(Conv2D(filters=32, kernel_size= (10, 10),strides=(1,1), padding="same", activation="relu"))
        self.__network.add(Conv2D(filters=128, kernel_size= (16, 16),strides=(1,1), padding="same", activation="relu"))
        self.__network.add(Conv2D(filters=256, kernel_size=(25 , 25), strides=(1, 1), padding="same", activation="relu"))
